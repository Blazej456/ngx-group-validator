...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgxGroupValidators", function() { return NgxGroupValidators; });
    ...
    static sync(config) {
        ...
        (formGroup) => {
            ...
            ([path, conditions]) => {
                ...
                /** @type {?} */
                const allErrors = Object.values(conditions).map((/**
                 * @param {?} data
                 * @return {?}
                 */
                (data) => {
                    ...
                    /** @type {?} */
                    let err = null;
                    if (data.condition.check(...data.condition.paths.map((/**
                     * @param {?} c
                     * @return {?}
                     */
                    c => formGroup.get(c))))) {
    ...
    static async(config) {
        ...
        (formGroup) => {
            ...
            ([path, conditions]) => {
                ...
                /** @type {?} */
                const asyncErrors = Object.values(conditions).map((/**
                 * @param {?} data
                 * @return {?}
                 */
                (data) => {
                ...
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])(asyncErrors)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(_mergeErrors), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(_assignName(path)));
            }));
...
/* harmony import */ var ngx_highlightjs_plus__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-highlightjs/plus */ "../../node_modules/ngx-highlightjs/fesm2015/ngx-highlightjs-plus.js");
...
/* harmony import */ var _sync_sync_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./sync/sync.component */ "./src/app/sync/sync.component.ts");
/* harmony import */ var _async_async_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./async/async.component */ "./src/app/async/async.component.ts");
...
function getHighlightLanguages() {
    return {
        ...
        json: () => __webpack_require__.e(/*! import() | highlight-js-lib-languages-json-js */ "common").then(__webpack_require__.t.bind(null, /*! highlight.js/lib/languages/json.js */ "../../node_modules/highlight.js/lib/languages/json.js", 7)),
        javascript: () => __webpack_require__.e(/*! import() | highlight-js-lib-languages-javascript-js */ "common").then(__webpack_require__.t.bind(null, /*! highlight.js/lib/languages/javascript.js */ "../../node_modules/highlight.js/lib/languages/javascript.js", 7)),
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _sync_sync_component__WEBPACK_IMPORTED_MODULE_12__["SyncComponent"],
            _async_async_component__WEBPACK_IMPORTED_MODULE_13__["AsyncComponent"]
        ],
        imports: [
            ...
            ngx_highlightjs_plus__WEBPACK_IMPORTED_MODULE_9__["HighlightPlusModule"],
...
/* harmony import */ var ngx_form_group_validator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-form-group-validator */ "../../dist/ngx-group-validator/fesm2015/ngx-group-validator.js");
                ...
                comment: [
                    {
                        ...
                        validators: control => {
                            return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["timer"])(500)
                                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(() => {
                                if (control.value) {
                                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(null);
                                }
                                return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])({ asyncRequired: 'eg. API Validation' });
                            }));
                        }
                    }
                ]
...
AsyncComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'fgv-demo-async',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./async.component.html */ "../../node_modules/raw-loader/dist/cjs.js!./src/app/async/async.component.html")).default
    })
], AsyncComponent);
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "../../node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @fortawesome/free-brands-svg-icons */ "../../node_modules/@fortawesome/free-brands-svg-icons/index.es.js");
/* harmony import */ var ngx_form_group_validator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-form-group-validator */ "../../dist/ngx-group-validator/fesm2015/ngx-group-validator.js");
...
SyncComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./sync.component.html */ "../../node_modules/raw-loader/dist/cjs.js!./src/app/sync/sync.component.html")).default
    })
], SyncComponent);
